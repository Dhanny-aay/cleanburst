...
const Packages = () => {
    return ( 
        ...
        <div className=" mt-32 px-16 w-full flex flex-col justify-center items-center">
            ...
            <p className=" mt-4 text-[#676767] font-Outfit text-base text-center px-[15%]">Discover our exclusive package deals, tailored to meet your needs and enhance your experience. Explore our wide range of offerings and unlock incredible value today</p>
            <div className=" w-full mt-16 grid grid-cols-3 gap-[32px]">
