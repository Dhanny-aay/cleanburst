...
const Hero = () => {
    return ( 
        <> 
        <div className=" w-full flex flex-row justify-between items-center mt-12 px-16">
            <div className=" fade-in w-[48%] flex-col">
                <p className=" font-Outfit font-medium text-[#48487F] text-xl">Clean Burst Powerwash LLC</p>
                <p className=" text-5xl mt-3 font-semibold font-Outfit">Providing Top Quality<br/> Service in your area.</p>
                ...
                <span className=' flex flex-row w-full space-x-8 mt-4'>
                    <button className=' bg-[#000] text-white px-8 py-4 rounded-md shadow-md font-Outfit text-base text-center font-medium'>Call Us</button>
                    <button className=' bg-[#48487F] text-white px-8 py-4 rounded-md shadow-md font-Outfit text-base text-center font-medium'>Book an Appointment</button>
                </span>
            </div>
            <div  className=" scale-up-center w-[48%] h-[420px] rounded-md relative flex items-end">
